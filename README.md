...
**[Try the live demo →](./demo/index.html)** (open in a browser locally, or enable GitHub Pages on this repo — no install needed. Click to add bodies, drag to launch them with velocity.)
